<template>
  <div class="gezi" v-if="userId&&orderNo">
    <div class="search">
      ...
      <div class="search-input" :class="{active:activeId==4}" @click="filter('MultiLoan',4)">
      ...
      <div class="search-input" :class="{active:activeId==3}" @click="filter('LendingCompanyPhone',3)">
