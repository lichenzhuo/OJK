...
const phl = {
  ...
  totalManage: {// Statistics Management
    ...
    realReturnMonry: 'Amount of Repaid Loan',
  ...
  loanAfterManage: {
    ...
    status: 'Reminding Status',
    name: 'Payment Reminder',
    time: 'the Latest Reminding Time',
    type: 'Overdue Type',
    type1: 'Collection Type',
    waitAmount: 'Amount to Repay',
  ...
  public: {// 一些公共的经常出现的
    ...
    registerPhone: 'registration phone number',
  ...
  new: {
    ...
    no76:'overdue loan(s)',
    no77:'the longest overdue days',
    no78:'former repaid loan(s)',
