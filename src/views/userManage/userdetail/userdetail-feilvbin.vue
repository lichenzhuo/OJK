    ...
    <div class="xuanxiangka">
      ...
      <ul class="xuan-2">
        <li class="xuan-2-1" v-if="active==1">
          <template>
            <li v-if="userSelf.name!==null&&userSelf.name!==undefined&&userSelf.name!==''">{{$t('public.no1')}}: <span>{{userSelf.name+' '+userSelf.middleName+' '+userSelf.surname}}</span></li>
            <li v-else>{{$t('public.no1')}}: <span> {{$store.state.common.nullData}} </span> </li>
          </template>
          <template>
            <li v-if="userIdcard.strIdType!==null&&userIdcard.strIdType!==undefined&&userIdcard.strIdType!==''">{{$t('fei.idType')}}: <span>{{userIdcard.strIdType}}</span>  </li>
            <li v-else>{{$t('fei.idType')}}: <span> {{$store.state.common.nullData}} </span> </li>
          </template>
          <template>
            <li v-if="userIdcard.idCard!==null&&userIdcard.idCard!==undefined&&userIdcard.idCard!==''">{{$t('fei.id')}}: <span>{{userIdcard.idCard}}</span>  </li>
            <li v-else>{{$t('fei.id')}}: <span> {{$store.state.common.nullData}} </span> </li>
          </template>
          <div class="idimgbox">
            <template>
        ...
        <li class="xuan-2-2" v-if="active==2">
          <div class="xuan-2-2-1">
            <template>
              <p v-if="userSelf.name!==null&&userSelf.name!==undefined&&userSelf.name!==''"><span>{{$t('public.no1')}}:</span> <span>{{userSelf.name+' '+userSelf.middleName+' '+userSelf.surname}}</span>  </p>
          ...
          <div class="xuan-2-2-1">
            ...
            <template>
              <p v-if="userIdcard.strIdType!==null&&userIdcard.strIdType!==undefined&&userIdcard.strIdType!==''"><span>{{$t('fei.idType')}}:</span> <span>{{userIdcard.strIdType}}</span>  </p>
              <p v-else><span>{{$t('fei.idType')}}:</span> <span> {{$store.state.common.nullData}} </span> </p>
            </template>
            <template>
              <p v-if="userIdcard.idCard!==null&&userIdcard.idCard!==undefined&&userIdcard.idCard!==''"><span>{{$t('fei.id')}}:</span> <span>{{userIdcard.idCard}}</span>  </p>
              <p v-else><span>{{$t('fei.id')}}:</span> <span> {{$store.state.common.nullData}} </span> </p>
            </template>
            <template>
              <p v-if="userSelf.degree!==null&&userSelf.degree!==undefined&&userSelf.degree!==''"><span>{{$t('public.no5')}}:</span> <span>{{$t($store.getters.education_phl(userSelf.degree))}}</span> </p>
              <p v-else><span>{{$t('public.no5')}}:</span> <span> {{$store.state.common.nullData}} </span> </p>
            </template>
          </div> 
          <div class="xuan-2-2-1">
            <template>
              <p v-if="userSelf.birthday!==null&&userSelf.birthday!==undefined&&userSelf.birthday!==''"><span>{{$t('public.birthday')}}:</span> <span>{{userSelf.birthday}}</span> </p>
          ...
          <div class="xuan-2-2-1">
            <p >
                <span>Facebook:</span> 
                <span v-if="userSelf.facebook!==null&&userSelf.facebook!==undefined&&userSelf.facebook!==''">{{userSelf.facebook}}</span>
                <span v-else>{{$store.state.common.nullData}}</span> 
              </p>
              <p >
                <span>Email:</span>
                <span v-if="userSelf.email!==null&&userSelf.email!==undefined&&userSelf.email!==''">{{userSelf.email}}</span>
                <span v-else>{{$store.state.common.nullData}}</span> 
              </p>
          </div> 
        ...
        <li class="xuan-2-3" v-if="active==3">
          <div class="xuan-2-3-1">
            ...
            <div class="xuan-2-3-1-1">
              <template>
                <p v-if="userWork.industryName!==null&&userWork.industryName!==undefined&&userWork.industryName!==''"><span>{{$t('yuenan.no5')}}:</span> <span>{{userWork.industryName}}</span> </p>
              ...
              <template>
                <p v-if="userWork.payday!==null&&userWork.payday!==undefined&&userWork.payday!==''"><span>{{$t('fei.inComeDate')}}:</span> <span>{{userWork.payday}}</span> </p>
