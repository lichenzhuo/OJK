        ...
        <li class="xuan-2-2" v-if="active1==1">
          <template >
            ...
            <div class="xuan-2-2-1" v-if="$store.state.common.lang==='vi'">
              ...
              <p >
                {{$t('yuenan.no25')}}:
                <span v-if="data.orderUserSelf.alternativePhone!==null&&data.orderUserSelf.alternativePhone!==undefined&&data.orderUserSelf.alternativePhone!==''">{{data.orderUserSelf.alternativePhone}}</span>
                <span v-else>{{$store.state.common.nullData}}</span> 
              </p>
            </div>
            <div class="xuan-2-2-1">
            ...
            <div class="xuan-2-2-1">
              <p v-if="$store.state.common.lang=='vi'">
                {{$t('websiteLoans.no5')}}: 
                <span v-if="data.orderInfo.orderLoanType!==null&&data.orderInfo.orderLoanType!==undefined&&data.orderInfo.orderLoanType!==''">{{$t($store.getters.loanTypeState(data.orderInfo.orderLoanType))}}</span>
                <span v-else>{{$store.state.common.nullData}}</span>
              </p>
              <p >
                {{$t('auditDetail.no45')}}: 
