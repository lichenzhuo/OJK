  ...
  <div class="public_main">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>{{$t('staffManage.crumbsTwo')}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>

    <div class="paixu">
      <span></span>
      <p>{{$t('staffManage.crumbsTwo')}}</p>
    </div>
    ...
    <div class="search">
      <el-row type="flex" justify="start" :gutter="10">
        ...
        <template  v-if="$store.state.common.permiss.includes('RIGHT_SYSTEM_APPROVE_QUERY')">
          <div class="search-input">
    ...
    <!-- -------------表单显示栏------------------------ -->
    <div class="table" v-if="$store.state.common.permiss.includes('RIGHT_SYSTEM_APPROVE_LIST')">
      <template>
        <el-table :data="tableData" stripe >
          <el-table-column align="center" prop="adminId" :label="$t('staffManage.id')" width="160">
          </el-table-column>
          <el-table-column align="center" prop="name" :label="$t('staffManage.xinshenyuan')" min-width="120">
          </el-table-column>
          ...
          <el-table-column align="center" prop="operation" :label="$t('public.operation')" min-width="120">
            <template slot-scope="scope">
              <span 
              v-if="$store.state.common.permiss.includes('RIGHT_SYSTEM_APPROVE_EDIT')"
    ...
    <el-row type="flex" justify="end">
        <div class="pages" v-if="$store.state.common.permiss.includes('RIGHT_SYSTEM_APPROVE_LIST')">
          <el-pagination
