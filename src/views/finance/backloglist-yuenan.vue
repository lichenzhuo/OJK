    ...
    <div class="table" v-if="$store.state.common.permiss.includes('RIGHT_ACCOUNT_REPAY_LIST')">
      <template>
        <el-table :data="tableData" size="small" stripe style="width:100%" empty-text>
          <el-table-column align="center" prop="id" :label="$t('public.backMoneyId')" width="70">
          </el-table-column>
          <el-table-column align="center" prop="orderId" :label="$t('public.orderId')" min-width="60">
          </el-table-column>
          <el-table-column align="center" prop="userId" :label="$t('public.userId')" min-width="66">
          </el-table-column>
          <el-table-column align="center" prop="userName" :label="$t('public.name')" min-width="76">
          </el-table-column>
          ...
          <el-table-column align="center" prop="couponDays" :label="$t('filter.couponCon')" min-width="68">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" prop="btId" :label="$t('finance.dealCode')" min-width="76">
          </el-table-column>
          <el-table-column align="center" prop="phone" :label="$t('public.no18')" min-width="70">
          </el-table-column>
          <el-table-column align="center" prop="loanAmount" :label="$t('public.no54')" min-width="80">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" prop="overdueInterestRate" :label="$t('proManage.overdueInterest')" min-width="50">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" prop="strApplyTime" :label="$t('public.CreateDate')" min-width="78">
          </el-table-column>
          <el-table-column align="center" prop="strLastRefundTime" :label="$t('public.backMoneyDate')" min-width="78">
          </el-table-column>
          ...
          <el-table-column align="center" prop="thirdChannel" :label="$t('finance.channel')" min-width="60">
          </el-table-column>
          <el-table-column align="center" prop="payType" :label="$t('finance.payType')" min-width="60">
          </el-table-column>
          <el-table-column align="center" prop="remark" :label="$t('public.no37')" min-width="80">
          </el-table-column>
