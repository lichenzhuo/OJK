    ...
    <div class="table" v-if="$store.state.common.permiss.includes('RIGHT_ACCOUNT_REPAY_LIST')">
      <template>
        <el-table :data="tableData" size="small" stripe style="width:100%" empty-text>
          ...
          <el-table-column align="center" prop="productPeriod" :label="$t('public.no31')+'('+$t('public.no26')+')'" min-width="70">
          </el-table-column>
          ...
          <el-table-column align="center" prop="returnMoney" :label="$t('public.no27')" min-width="60">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" prop="contractNo" :label="$t('fei.loanId')" min-width="70">
          </el-table-column>
          ...
          <!-- <el-table-column align="center" prop="operation" :label="$t('public.operation')" min-width="130">
            <template slot-scope="scope">
              ...
              <template v-if="$store.state.common.permiss.includes('RIGHT_ACCOUNT_REPAY_REPAY')">
                <span 
                  v-if="scope.row.status!==51"
                  style="color:#547ef6;cursor:pointer" 
                  @click="sure(scope.row.repaymentNo)">
                  {{$t('public.no61')}}
                </span>
              </template>
            </template>
