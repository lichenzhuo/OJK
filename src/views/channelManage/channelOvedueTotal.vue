  ...
  <div class="usermanage">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>{{$t('channelManage.crumbsFour')}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-row>
      <el-col :span="24">
        <div class="paixu">
          <span></span>
          <p>{{$t('channelManage.crumbsFour')}}</p>
        </div>
      </el-col>
    </el-row>
    ...
    <div class="table">
      <template>
        <el-table :data="tableData" size="small" stripe style="width: 100%" empty-text>
          <el-table-column align="center" prop="strCreateTime" :label="$t('public.no33')" width="120">
          ...
          <el-table-column align="center" prop="machineCount" :label="$t('channelManage.no5')" min-width="120">
          </el-table-column>
          <el-table-column align="center" prop="firstCount" :label="$t('channelManage.no4')" min-width="140">
          </el-table-column>
          <el-table-column align="center" prop="reviewCount" :label="$t('channelManage.no13')" min-width="140">
          </el-table-column>
          <el-table-column align="center" prop="laveCount" :label="$t('channelManage.no14')" min-width="100">
          </el-table-column>
          <el-table-column align="center" prop="laveCount" :label="$t('channelManage.no15')" min-width="100">
          </el-table-column>
          <el-table-column align="center" prop="laveCount" :label="$t('channelManage.no16')" min-width="100">
          </el-table-column>
          <el-table-column align="center" prop="laveCount" :label="$t('channelManage.no17')" min-width="100">
          </el-table-column>
        </el-table>
      </template>
    </div>
